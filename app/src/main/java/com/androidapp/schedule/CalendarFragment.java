 ...
 * Use the {@link com.androidapp.schedule.CalendarFragment#newInstance} factory method to
...
public class CalendarFragment extends Fragment {
    ...
    public static com.androidapp.schedule.CalendarFragment newInstance(String param1, String param2) {
        com.androidapp.schedule.CalendarFragment fragment = new com.androidapp.schedule.CalendarFragment();
    ...
    public void onActivityCreated(Bundle b){
        ...
        calendarView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(String.valueOf(com.androidapp.schedule.CalendarFragment.this));
